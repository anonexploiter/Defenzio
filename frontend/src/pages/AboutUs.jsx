    ...
    <div>
      ...
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <h2 className="about-title">About Defenzio</h2>
          <p>
            Welcome to Defenzio, a cutting-edge platform dedicated to providing comprehensive cybersecurity solutions. At
            Defenzio, we are committed to safeguarding your digital assets and protecting you from emerging cyber threats.
          </p>
          ...
          <p>
            At Defenzio, we combine state-of-the-art technologies, threat intelligence, and expert analysis to detect and
          ...
          <p>
            At Defenzio, we prioritize the security and privacy of your data. We adhere to industry best practices and
          ...
          <div className="contact-info">
            ...
            <p>
              ...
              <strong>[Contact Email : <a href="mailto:astayami001@gmail.com">astayami001@gmail.com</a>]</strong>, and we'll be happy to assist you.
            </p>
          </div>
        </div>
